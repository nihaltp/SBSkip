...
class FFmpegMediaProcessorTest {
    ...
    @Test
    fun testEmptyKeepRanges_mp4_convertToAudio() = kotlinx.coroutines.runBlocking {
    ...
    @Test
    fun testEmptyKeepRanges_webm_convertToAudio() = kotlinx.coroutines.runBlocking {
    ...
    @Test
    fun testEmptyKeepRanges_noConversion() = kotlinx.coroutines.runBlocking {
        val inputFile = createDummyFile("input.webm")
    ...
    @Test
    fun testSingleKeepRange_mp4_convertToAudio() = kotlinx.coroutines.runBlocking {
        val inputFile = createDummyFile("input.mp4")
        val outputFile = File(tempDir, "output.m4a")
    ...
    @Test
    fun testSingleKeepRange_webm_convertToAudio() = kotlinx.coroutines.runBlocking {
        val inputFile = createDummyFile("input.webm")
        val outputFile = File(tempDir, "output.m4a")
    ...
    @Test
    fun testSingleKeepRange_webm_noConversion() = kotlinx.coroutines.runBlocking {
        val inputFile = createDummyFile("input.webm")
        val outputFile = File(tempDir, "output.webm")
    ...
    @Test
    fun testMultipleKeepRanges_webm_convertToAudio() = kotlinx.coroutines.runBlocking {
        val inputFile = createDummyFile("input.webm")
        val outputFile = File(tempDir, "output.m4a")
    ...
    @Test
    fun testMultipleKeepRanges_mkv_noConversion() = kotlinx.coroutines.runBlocking {
